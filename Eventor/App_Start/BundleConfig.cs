...
namespace Eventor
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/selectAll").Include(
                      "~/Scripts/SelectAllScript.js"));

            bundles.Add(new ScriptBundle("~/bundles/AddToCart").Include(
                      "~/Scripts/AddToCart.js"));

            bundles.Add(new ScriptBundle("~/bundles/ReenviarEmail").Include(
                      "~/Scripts/ReenviarEmail.js"));
